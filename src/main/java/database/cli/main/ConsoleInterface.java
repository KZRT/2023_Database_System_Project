...
//        this.selectDatatypeWithOperationMenu = new SelectDatatypeWithOperationMenu();
//        this.countDatatypeWithOperationMenu = new CountDatatypeWithOperationMenu();
//        this.testTablesMenu = new TestTablesMenu();
    }
